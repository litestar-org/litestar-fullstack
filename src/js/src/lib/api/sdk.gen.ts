...
import type { SystemHealthData, SystemHealthResponse, ForgotPasswordData, ForgotPasswordResponse2, ForgotPasswordError, AccountLoginData, AccountLoginResponse, AccountLoginError, AccountLogoutData, AccountLogoutResponse, ValidateResetTokenData, ValidateResetTokenResponse2, ValidateResetTokenError, ResetPasswordData, ResetPasswordResponse2, ResetPasswordError, AccountRegisterData, AccountRegisterResponse, AccountRegisterError, ApiEmailVerificationStatusUserIdGetVerificationStatusData, ApiEmailVerificationStatusUserIdGetVerificationStatusResponse, ApiEmailVerificationStatusUserIdGetVerificationStatusError, ApiEmailVerificationRequestRequestVerificationData, ApiEmailVerificationRequestRequestVerificationResponse, ApiEmailVerificationRequestRequestVerificationError, ApiEmailVerificationVerifyVerifyEmailData, ApiEmailVerificationVerifyVerifyEmailResponse, ApiEmailVerificationVerifyVerifyEmailError, ApiAuthOauthAccountsGetOauthAccountsData, ApiAuthOauthAccountsGetOauthAccountsResponse, ApiAuthOauthAccountsGetOauthAccountsError, ApiAuthOauthGoogleGoogleAuthorizeData, ApiAuthOauthGoogleGoogleAuthorizeResponse, ApiAuthOauthGoogleGoogleAuthorizeError, ApiAuthOauthGoogleCallbackGoogleCallbackData, ApiAuthOauthGoogleCallbackGoogleCallbackResponse, ApiAuthOauthGoogleCallbackGoogleCallbackError, ApiAuthOauthLinkLinkOauthAccountData, ApiAuthOauthLinkLinkOauthAccountResponse, ApiAuthOauthLinkLinkOauthAccountError, ApiAuthOauthUnlinkUnlinkOauthAccountData, ApiAuthOauthUnlinkUnlinkOauthAccountResponse, ApiAuthOauthUnlinkUnlinkOauthAccountError, AccountProfileData, AccountProfileResponse, AccountProfileUpdateData, AccountProfileUpdateResponse, AccountProfileUpdateError, AccountDeleteData, AccountDeleteResponse, AccountPasswordUpdateData, AccountPasswordUpdateResponse, AccountPasswordUpdateError, DeleteRoleData, DeleteRoleResponse, DeleteRoleError, GetRoleData, GetRoleResponse, GetRoleError, UpdateRoleData, UpdateRoleResponse, UpdateRoleError, CreateRoleData, CreateRoleResponse, CreateRoleError, ListRolesData, ListRolesResponse, ListRolesError, ListUsersData, ListUsersResponse, ListUsersError, CreateUserData, CreateUserResponse, CreateUserError, DeleteUserData, DeleteUserResponse, DeleteUserError, GetUserData, GetUserResponse, GetUserError, UpdateUserData, UpdateUserResponse, UpdateUserError, ListTeamsData, ListTeamsResponse, ListTeamsError, CreateTeamData, CreateTeamResponse, CreateTeamError, DeleteTeamData, DeleteTeamResponse, DeleteTeamError, GetTeamData, GetTeamResponse, GetTeamError, UpdateTeamData, UpdateTeamResponse, UpdateTeamError, DeleteTeamInvitationData, DeleteTeamInvitationResponse, DeleteTeamInvitationError, AcceptTeamInvitationData, AcceptTeamInvitationResponse, AcceptTeamInvitationError, ListTeamInvitationsData, ListTeamInvitationsResponse, ListTeamInvitationsError, CreateTeamInvitationData, CreateTeamInvitationResponse, CreateTeamInvitationError, RevokeUserRoleData, RevokeUserRoleResponse, RevokeUserRoleError, AssignUserRoleData, AssignUserRoleResponse, AssignUserRoleError, RemoveMemberFromTeamData, RemoveMemberFromTeamResponse, RemoveMemberFromTeamError, AddMemberToTeamData, AddMemberToTeamResponse, AddMemberToTeamError, DeleteTagData, DeleteTagResponse, DeleteTagError, GetTagData, GetTagResponse, GetTagError, UpdateTagData, UpdateTagResponse, UpdateTagError, CreateTagData, CreateTagResponse, CreateTagError, ListTagsData, ListTagsResponse, ListTagsError } from './types.gen';
 ...
 */
export const apiEmailVerificationStatusUserIdGetVerificationStatus = <ThrowOnError extends boolean = false>(options: Options<ApiEmailVerificationStatusUserIdGetVerificationStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiEmailVerificationStatusUserIdGetVerificationStatusResponse, ApiEmailVerificationStatusUserIdGetVerificationStatusError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * RequestVerification
 */
export const apiEmailVerificationRequestRequestVerification = <ThrowOnError extends boolean = false>(options: Options<ApiEmailVerificationRequestRequestVerificationData, ThrowOnError>) => {
