    ...
    <aside className="w-64 border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-full flex-col">
        ...
        <div className="border-b p-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button type="button" className="flex w-full items-center gap-3 rounded-lg p-2 hover:bg-accent">
                <Avatar>
        ...
        <nav className="flex-1 space-y-1 p-4">
          <Link to="/home" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium hover:bg-accent">
            <Home className="h-4 w-4" />
            Home
          </Link>
          {userProfile?.isSuperuser && (
            <Link to="/admin" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium hover:bg-accent">
