...
export const accountLogin = <ThrowOnError extends boolean = false>(options: Options<AccountLoginData, ThrowOnError>) =>
  (options.client ?? client).post<AccountLoginResponses, AccountLoginErrors, ThrowOnError>({
...
export const accountLogout = <ThrowOnError extends boolean = false>(options?: Options<AccountLogoutData, ThrowOnError>) =>
  (options?.client ?? client).post<AccountLogoutResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const tokenRefresh = <ThrowOnError extends boolean = false>(options?: Options<TokenRefreshData, ThrowOnError>) =>
  (options?.client ?? client).post<TokenRefreshResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const validateResetToken = <ThrowOnError extends boolean = false>(options: Options<ValidateResetTokenData, ThrowOnError>) =>
  (options.client ?? client).get<ValidateResetTokenResponses, ValidateResetTokenErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const revokeAllSessions = <ThrowOnError extends boolean = false>(options?: Options<RevokeAllSessionsData, ThrowOnError>) =>
  (options?.client ?? client).delete<RevokeAllSessionsResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * GetSessions
 */
export const getActiveSessions = <ThrowOnError extends boolean = false>(options?: Options<GetActiveSessionsData, ThrowOnError>) =>
  (options?.client ?? client).get<GetActiveSessionsResponses, GetActiveSessionsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/access/sessions",
    ...options,
  })
...
export const revokeSession = <ThrowOnError extends boolean = false>(options: Options<RevokeSessionData, ThrowOnError>) =>
  (options.client ?? client).delete<RevokeSessionResponses, RevokeSessionErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const accountRegister = <ThrowOnError extends boolean = false>(options: Options<AccountRegisterData, ThrowOnError>) =>
  (options.client ?? client).post<AccountRegisterResponses, AccountRegisterErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * ListLogs
 */
export const adminListAuditLogs = <ThrowOnError extends boolean = false>(options?: Options<AdminListAuditLogsData, ThrowOnError>) =>
  (options?.client ?? client).get<AdminListAuditLogsResponses, AdminListAuditLogsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/audit",
    ...options,
  })
 ...
 * GetTargetLogs
 */
export const adminGetTargetAuditLogs = <ThrowOnError extends boolean = false>(options: Options<AdminGetTargetAuditLogsData, ThrowOnError>) =>
  (options.client ?? client).get<AdminGetTargetAuditLogsResponses, AdminGetTargetAuditLogsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * GetUserLogs
 */
export const adminGetUserAuditLogs = <ThrowOnError extends boolean = false>(options: Options<AdminGetUserAuditLogsData, ThrowOnError>) =>
  (options.client ?? client).get<AdminGetUserAuditLogsResponses, AdminGetUserAuditLogsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * GetLog
 */
export const adminGetAuditLog = <ThrowOnError extends boolean = false>(options: Options<AdminGetAuditLogData, ThrowOnError>) =>
  (options.client ?? client).get<AdminGetAuditLogResponses, AdminGetAuditLogErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const getRecentActivity = <ThrowOnError extends boolean = false>(options?: Options<GetRecentActivityData, ThrowOnError>) =>
  (options?.client ?? client).get<GetRecentActivityResponses, GetRecentActivityErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const getDashboardStats = <ThrowOnError extends boolean = false>(options?: Options<GetDashboardStatsData, ThrowOnError>) =>
  (options?.client ?? client).get<GetDashboardStatsResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * ListTeams
 */
export const adminListTeams = <ThrowOnError extends boolean = false>(options?: Options<AdminListTeamsData, ThrowOnError>) =>
  (options?.client ?? client).get<AdminListTeamsResponses, AdminListTeamsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/teams",
    ...options,
  })
 ...
 * DeleteTeam
 */
export const adminDeleteTeam = <ThrowOnError extends boolean = false>(options: Options<AdminDeleteTeamData, ThrowOnError>) =>
  (options.client ?? client).delete<AdminDeleteTeamResponses, AdminDeleteTeamErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * GetTeam
 */
export const adminGetTeam = <ThrowOnError extends boolean = false>(options: Options<AdminGetTeamData, ThrowOnError>) =>
  (options.client ?? client).get<AdminGetTeamResponses, AdminGetTeamErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/teams/{team_id}",
    ...options,
  })
 ...
 * UpdateTeam
 */
export const adminUpdateTeam = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateTeamData, ThrowOnError>) =>
  (options.client ?? client).patch<AdminUpdateTeamResponses, AdminUpdateTeamErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/teams/{team_id}",
    ...options,
    headers: {
...
export const adminListUsers = <ThrowOnError extends boolean = false>(options?: Options<AdminListUsersData, ThrowOnError>) =>
  (options?.client ?? client).get<AdminListUsersResponses, AdminListUsersErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/users",
    ...options,
  })
...
export const adminGetUser = <ThrowOnError extends boolean = false>(options: Options<AdminGetUserData, ThrowOnError>) =>
  (options.client ?? client).get<AdminGetUserResponses, AdminGetUserErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/users/{user_id}",
    ...options,
  })
...
export const adminUpdateUser = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateUserData, ThrowOnError>) =>
  (options.client ?? client).patch<AdminUpdateUserResponses, AdminUpdateUserErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/users/{user_id}",
    ...options,
    headers: {
 ...
 * GithubAuthorize
 */
export const apiAuthOauthGithubGithubAuthorize = <ThrowOnError extends boolean = false>(options?: Options<ApiAuthOauthGithubGithubAuthorizeData, ThrowOnError>) =>
  (options?.client ?? client).get<ApiAuthOauthGithubGithubAuthorizeResponses, ApiAuthOauthGithubGithubAuthorizeErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * GithubCallback
 */
export const apiAuthOauthGithubCallbackGithubCallback = <ThrowOnError extends boolean = false>(options?: Options<ApiAuthOauthGithubCallbackGithubCallbackData, ThrowOnError>) =>
  (options?.client ?? client).get<ApiAuthOauthGithubCallbackGithubCallbackResponses, ApiAuthOauthGithubCallbackGithubCallbackErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const apiAuthOauthGoogleGoogleAuthorize = <ThrowOnError extends boolean = false>(options?: Options<ApiAuthOauthGoogleGoogleAuthorizeData, ThrowOnError>) =>
  (options?.client ?? client).get<ApiAuthOauthGoogleGoogleAuthorizeResponses, ApiAuthOauthGoogleGoogleAuthorizeErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const apiAuthOauthGoogleCallbackGoogleCallback = <ThrowOnError extends boolean = false>(options?: Options<ApiAuthOauthGoogleCallbackGoogleCallbackData, ThrowOnError>) =>
  (options?.client ?? client).get<ApiAuthOauthGoogleCallbackGoogleCallbackResponses, ApiAuthOauthGoogleCallbackGoogleCallbackErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 */
export const oAuthConfig = <ThrowOnError extends boolean = false>(options?: Options<OAuthConfigData, ThrowOnError>) =>
...
export const apiEmailVerificationRequestRequestVerification = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<ApiEmailVerificationRequestRequestVerificationResponses, ApiEmailVerificationRequestRequestVerificationErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const apiEmailVerificationStatusUserIdGetVerificationStatus = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<ApiEmailVerificationStatusUserIdGetVerificationStatusResponses, ApiEmailVerificationStatusUserIdGetVerificationStatusErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const apiEmailVerificationVerifyVerifyEmail = <ThrowOnError extends boolean = false>(options: Options<ApiEmailVerificationVerifyVerifyEmailData, ThrowOnError>) =>
  (options.client ?? client).post<ApiEmailVerificationVerifyVerifyEmailResponses, ApiEmailVerificationVerifyVerifyEmailErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const accountProfile = <ThrowOnError extends boolean = false>(options?: Options<AccountProfileData, ThrowOnError>) =>
  (options?.client ?? client).get<AccountProfileResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/me",
    ...options,
  })
...
export const accountProfileUpdate = <ThrowOnError extends boolean = false>(options: Options<AccountProfileUpdateData, ThrowOnError>) =>
  (options.client ?? client).patch<AccountProfileUpdateResponses, AccountProfileUpdateErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/me",
    ...options,
    headers: {
...
export const accountPasswordUpdate = <ThrowOnError extends boolean = false>(options: Options<AccountPasswordUpdateData, ThrowOnError>) =>
  (options.client ?? client).patch<AccountPasswordUpdateResponses, AccountPasswordUpdateErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/me/password",
    ...options,
    headers: {
...
export const verifyMfaChallenge = <ThrowOnError extends boolean = false>(options: Options<VerifyMfaChallengeData, ThrowOnError>) =>
  (options.client ?? client).post<VerifyMfaChallengeResponses, VerifyMfaChallengeErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * ConfirmSetup
 */
export const confirmMfaSetup = <ThrowOnError extends boolean = false>(options: Options<ConfirmMfaSetupData, ThrowOnError>) =>
  (options.client ?? client).post<ConfirmMfaSetupResponses, ConfirmMfaSetupErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/mfa/confirm",
    ...options,
    headers: {
 ...
 * InitiateSetup
 */
export const initiateMfaSetup = <ThrowOnError extends boolean = false>(options?: Options<InitiateMfaSetupData, ThrowOnError>) =>
  (options?.client ?? client).post<InitiateMfaSetupResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/mfa/enable",
    ...options,
  })
 ...
 */
export const regenerateMfaBackupCodes = <ThrowOnError extends boolean = false>(options: Options<RegenerateMfaBackupCodesData, ThrowOnError>) =>
  (options.client ?? client).post<RegenerateMfaBackupCodesResponses, RegenerateMfaBackupCodesErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * ListAccounts
 */
export const profileOAuthAccounts = <ThrowOnError extends boolean = false>(options?: Options<ProfileOAuthAccountsData, ThrowOnError>) =>
  (options?.client ?? client).get<ProfileOAuthAccountsResponses, ProfileOAuthAccountsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * Unlink
 */
export const profileOAuthUnlink = <ThrowOnError extends boolean = false>(options: Options<ProfileOAuthUnlinkData, ThrowOnError>) =>
  (options.client ?? client).delete<ProfileOAuthUnlinkResponses, ProfileOAuthUnlinkErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * CompleteLink
 */
export const profileOAuthComplete = <ThrowOnError extends boolean = false>(options: Options<ProfileOAuthCompleteData, ThrowOnError>) =>
  (options.client ?? client).get<ProfileOAuthCompleteResponses, ProfileOAuthCompleteErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * StartLink
 */
export const profileOAuthLink = <ThrowOnError extends boolean = false>(options: Options<ProfileOAuthLinkData, ThrowOnError>) =>
  (options.client ?? client).post<ProfileOAuthLinkResponses, ProfileOAuthLinkErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * UpgradeScopes
 */
export const profileOAuthUpgradeScopes = <ThrowOnError extends boolean = false>(options: Options<ProfileOAuthUpgradeScopesData, ThrowOnError>) =>
  (options.client ?? client).post<ProfileOAuthUpgradeScopesResponses, ProfileOAuthUpgradeScopesErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const revokeRole = <ThrowOnError extends boolean = false>(options: Options<RevokeRoleData, ThrowOnError>) =>
  (options.client ?? client).post<RevokeRoleResponses, RevokeRoleErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const listTeams = <ThrowOnError extends boolean = false>(options?: Options<ListTeamsData, ThrowOnError>) =>
  (options?.client ?? client).get<ListTeamsResponses, ListTeamsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/teams",
    ...options,
  })
...
export const listTeamInvitations = <ThrowOnError extends boolean = false>(options: Options<ListTeamInvitationsData, ThrowOnError>) =>
  (options.client ?? client).get<ListTeamInvitationsResponses, ListTeamInvitationsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const createTeamInvitation = <ThrowOnError extends boolean = false>(options: Options<CreateTeamInvitationData, ThrowOnError>) =>
  (options.client ?? client).post<CreateTeamInvitationResponses, CreateTeamInvitationErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/teams/{team_id}/invitations",
    ...options,
    headers: {
...
export const deleteTeamInvitation = <ThrowOnError extends boolean = false>(options: Options<DeleteTeamInvitationData, ThrowOnError>) =>
  (options.client ?? client).delete<DeleteTeamInvitationResponses, DeleteTeamInvitationErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const acceptTeamInvitation = <ThrowOnError extends boolean = false>(options: Options<AcceptTeamInvitationData, ThrowOnError>) =>
  (options.client ?? client).post<AcceptTeamInvitationResponses, AcceptTeamInvitationErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 */
export const rejectTeamInvitation = <ThrowOnError extends boolean = false>(options: Options<RejectTeamInvitationData, ThrowOnError>) =>
  (options.client ?? client).post<RejectTeamInvitationResponses, RejectTeamInvitationErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const removeMemberFromTeam = <ThrowOnError extends boolean = false>(options: Options<RemoveMemberFromTeamData, ThrowOnError>) =>
  (options.client ?? client).delete<RemoveMemberFromTeamResponses, RemoveMemberFromTeamErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const addMemberToTeam = <ThrowOnError extends boolean = false>(options: Options<AddMemberToTeamData, ThrowOnError>) =>
  (options.client ?? client).post<AddMemberToTeamResponses, AddMemberToTeamErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/teams/{team_id}/members",
    ...options,
    headers: {
...
export const updateTeamMember = <ThrowOnError extends boolean = false>(options: Options<UpdateTeamMemberData, ThrowOnError>) =>
  (options.client ?? client).patch<UpdateTeamMemberResponses, UpdateTeamMemberErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
...
export const revokeUserRole = <ThrowOnError extends boolean = false>(options: Options<RevokeUserRoleData, ThrowOnError>) =>
  (options.client ?? client).delete<RevokeUserRoleResponses, RevokeUserRoleErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/users/roles",
    ...options,
    headers: {
...
export const assignUserRole = <ThrowOnError extends boolean = false>(options: Options<AssignUserRoleData, ThrowOnError>) =>
  (options.client ?? client).post<AssignUserRoleResponses, AssignUserRoleErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/users/roles",
    ...options,
    headers: {
...
export const accountDelete = <ThrowOnError extends boolean = false>(options?: Options<AccountDeleteData, ThrowOnError>) =>
  (options?.client ?? client).delete<AccountDeleteResponses, unknown, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/profile",
    ...options,
  })
