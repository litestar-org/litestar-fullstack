...
from tests.factories import get_raw_token
...
@pytest.mark.anyio
async def test_signup_success(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_signup_duplicate_email(client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_signup_invalid_email(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_signup_weak_password(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_login_success(client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_login_wrong_password(client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_login_nonexistent_user(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_login_inactive_user(client: AsyncTestClient, inactive_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_get_current_user(authenticated_client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_get_current_user_unauthenticated(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_update_profile(authenticated_client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_change_password_success(authenticated_client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_change_password_wrong_current(authenticated_client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_change_password_weak_new_password(authenticated_client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_logout_success(authenticated_client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_request_password_reset(client: AsyncTestClient, test_user: m.User) -> None:
...
@pytest.mark.anyio
async def test_request_password_reset_nonexistent_user(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_reset_password_invalid_token(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_rate_limiting_signup(client: AsyncTestClient) -> None:
...
@pytest.mark.anyio
async def test_csrf_protection(client: AsyncTestClient) -> None:
