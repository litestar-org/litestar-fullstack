...
class TestTeamServiceCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_team_with_owner(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_team_by_id(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_team_by_slug(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_team(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_team(self, session: AsyncSession, team_service: TeamService) -> None:
        """Test deleting team."""
        team = TeamFactory.build()
        session.add(team)
        await session.commit()
    ...
    @pytest.mark.asyncio
    async def test_list_teams(self, session: AsyncSession, team_service: TeamService) -> None:
        """Test listing teams."""
...
class TestTeamServiceOwnershipAndMembers:
    """Test team ownership and member management."""

    @pytest.mark.asyncio
    async def test_create_team_with_owner_user_object(self, session: AsyncSession, team_service: TeamService) -> None:
...
class TestTeamServicePermissions:
    """Test team permission and access control methods."""

    def test_can_view_all_superuser_flag(self) -> None:
    ...
    def test_can_view_all_user_no_roles(self) -> None:
...
class TestTeamServiceSlugHandling:
    """Test slug generation and handling."""

    @pytest.mark.asyncio
    async def test_populate_slug_when_missing(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_populate_slug_without_name(self, session: AsyncSession, team_service: TeamService) -> None:
...
class TestTeamServiceTagManagement:
...
class TestTeamServiceErrorHandling:
    """Test error handling and edge cases."""

    @pytest.mark.asyncio
    async def test_get_nonexistent_team(self, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_team_empty_name(self, team_service: TeamService) -> None:
...
class TestTeamServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_team_lifecycle(self, session: AsyncSession, team_service: TeamService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_team_with_multiple_members_and_tags(self, session: AsyncSession, team_service: TeamService) -> None:
