...
def test_is_expired_false_for_future_expiration() -> None:
...
def test_is_expired_true_for_past_expiration() -> None:
...
def test_is_used_false_when_used_at_is_none() -> None:
...
def test_is_used_true_when_used_at_is_set() -> None:
...
def test_is_valid_true_when_not_expired_and_not_used() -> None:
...
def test_is_valid_false_when_expired() -> None:
...
def test_is_valid_false_when_used() -> None:
...
def test_is_valid_false_when_expired_and_used() -> None:
