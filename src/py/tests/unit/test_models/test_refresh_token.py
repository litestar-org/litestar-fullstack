...
def test_is_expired_at_exact_time() -> None:
...
def test_is_valid_property_false_revoked() -> None:
...
def test_is_valid_property_false_both() -> None:
...
def test_create_expires_at_custom_days() -> None:
...
def test_create_expires_at_short_duration() -> None:
...
def test_family_id_generation() -> None:
...
def test_different_tokens_same_family() -> None:
...
def test_different_tokens_different_families() -> None:
...
def test_device_info_field() -> None:
...
def test_device_info_with_ip() -> None:
...
def test_device_info_with_ipv6() -> None:
...
def test_optional_device_info_field() -> None:
...
def test_token_hash_is_stored() -> None:
...
def test_revocation_timestamp_precision() -> None:
...
def test_user_id_relationship() -> None:
...
def test_multiple_tokens_per_user() -> None:
    ...
    assert len({t.id for t in tokens}) == 5  # All unique IDs


def test_valid_to_expired_transition() -> None:
...
def test_valid_to_revoked_transition() -> None:
