...
class TestRequiresTeamMembership:
    """Test requires_team_membership guard."""
    ...
    def test_non_member_raises_permission_denied(self) -> None:
    ...
    def test_no_teams_raises_permission_denied(self) -> None:
    ...
    def test_non_superuser_role_fails(self) -> None:
...
class TestRequiresTeamAdmin:
    """Test requires_team_admin guard."""
    ...
    def test_team_admin_passes(self) -> None:
    ...
    def test_team_member_fails(self) -> None:
    ...
    def test_admin_of_different_team_fails(self) -> None:
...
class TestRequiresTeamOwnership:
    """Test requires_team_ownership guard."""
    ...
    def test_team_owner_passes(self) -> None:
    ...
    def test_team_admin_non_owner_fails(self) -> None:
    ...
    def test_owner_of_different_team_fails(self) -> None:
    ...
    def test_no_memberships_fails(self) -> None:
...
class TestGuardHierarchy:
    """Test guard hierarchy and interactions."""

    def test_owner_passes_all_guards(self) -> None:
    ...
    def test_admin_passes_membership_and_admin(self) -> None:
    ...
    def test_member_passes_only_membership(self) -> None:
...
class TestMultipleTeamMemberships:
    """Test scenarios with multiple team memberships."""

    def test_member_of_requested_team_among_many(self) -> None:
    ...
    def test_admin_in_one_member_in_another(self) -> None:
