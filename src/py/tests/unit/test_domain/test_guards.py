...
class TestProvideUser:
    """Test provide_user dependency function."""

    def test_provide_user_returns_request_user(self) -> None:
    ...
    def test_provide_user_with_different_user_types(self) -> None:
...
class TestRequiresActiveUser:
    """Test requires_active_user guard."""
    ...
    def test_inactive_user_raises_permission_denied(self) -> None:
...
class TestRequiresVerifiedUser:
    """Test requires_verified_user guard."""
    ...
    def test_unverified_user_raises_permission_denied(self) -> None:
...
class TestRequiresSuperuser:
    """Test requires_superuser guard."""

    def test_superuser_flag_passes(self) -> None:
    ...
    def test_non_superuser_raises_permission_denied(self) -> None:
    ...
    def test_user_with_non_superuser_role_raises(self) -> None:
...
class TestCreateAccessToken:
    ...
    def test_token_with_password_auth_method(self) -> None:
    ...
    def test_token_with_oauth_auth_method(self) -> None:
    ...
    def test_token_with_custom_amr(self) -> None:
    ...
    def test_token_default_values(self) -> None:
...
class TestGuardCombinations:
    """Test combinations of guards."""

    def test_active_verified_superuser_passes_all(self) -> None:
    ...
    def test_active_verified_non_superuser_fails_superuser_guard(self) -> None:
    ...
    def test_inactive_user_fails_early(self) -> None:
...
class TestTokenSecurity:
    ...
    def test_token_contains_no_password(self) -> None:
    ...
    def test_same_user_different_times_get_different_tokens(self) -> None:
