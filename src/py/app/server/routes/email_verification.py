...
from app.schemas.accounts import EmailVerificationConfirm, EmailVerificationRequest, User
from app.server.deps import provide_email_verification_service, provide_users_service
...
class EmailVerificationController(Controller):
    ...
    async def request_verification(
        ...
        users_service: Annotated[UserService, Dependency()],
        verification_service: Annotated[EmailVerificationTokenService, Dependency()],
    ) -> dict[str, str]:
