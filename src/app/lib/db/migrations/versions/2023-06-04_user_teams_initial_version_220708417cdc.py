"""user-teams initial version

Revision ID: 220708417cdc
Revises: 
Create Date: 2023-06-04 17:13:21.927980
...
def downgrade():
    ...
    sa.Column('_sentinel', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_whatever')
    )
